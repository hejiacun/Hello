...
public class StringUtil extends StringUtils {
    ...
    /*public static String dateToChinese(Date date) {
        ...
        long cha = (DateUtil.getDate().getTime() - date.getTime()) / 1000;
    ...
    /*public static String getHideName(String realName) {
        ...
        realName = realName.replace(SPACE, EMPTY);
        if (StringUtil.isMobile(realName)) {
            return FuzzUtil.fuzz(realName, "3~6");
        } else {
            return FuzzUtil.fuzz(realName, "0");
        }
    }*/
     ...
     * @return
     */
    /*public static String getFuzzyName(String realName) {
        if (isBlank(realName)) {
            return null;
        }
        realName = realName.replace(SPACE, EMPTY);
        if (StringUtil.isMobile(realName)) {
            ...
            return FuzzUtil.fuzz(realName, "1~-1");
        }
    }*/
     ...
     * @return
     */
    /*public static String getHideBankCardNumber(String idCardNo) {
        if (isBlank(idCardNo)) {
            return null;
        }
        idCardNo = idCardNo.replace(SPACE, EMPTY);
        return FuzzUtil.fuzz(idCardNo, "0~-5");
    }*/
   ...
   /* public static String getHideIdCardNo(String idCardNo) {
        ...
        idCardNo = idCardNo.replace(SPACE, EMPTY);
        return FuzzUtil.fuzz(idCardNo, "4~-3");
    }*/
    ...
    /*public static String getHidePhoneNo(String phoneNo) {
        ...
        phoneNo = phoneNo.replace(SPACE, EMPTY);
        return FuzzUtil.fuzz(phoneNo, "3~6");
    }*/
    ...
    /**
     * 生成指定lenth，case的时间戳的流水号
     *
     * @param length          随机数的长度
     * @param isOnlyNumber    是否只有数字
     * @param isOnlyLowerCase 是否只有小写
     */
    /*public static String generateStreamCode(int length, boolean isOnlyNumber, boolean isOnlyLowerCase) {
        return DateUtil.getNowTimeSeqStr() + getRandomCode(length, isOnlyNumber, isOnlyLowerCase);
    }*/
     ...
     * @return
     */
    public static String getKey(String pattern, Object... arguments) {
