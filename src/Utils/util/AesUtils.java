...
public class AesUtils {
	...
	public static final String SECURITY_TYPE = "AES";

	/**
	 * 加密
	 */
	public static String encrypt(String key, String data) throws Exception {
		SecretKey secretKey = new SecretKeySpec(Base64.decodeBase64(key), SECURITY_TYPE);
		Cipher cipher = Cipher.getInstance(SECURITY_TYPE);
